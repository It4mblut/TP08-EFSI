...
const styles = StyleSheet.create({
  ...
  sidebarNombre: { color: 'white', fontWeight: 'bold', fontSize: 16 },
  sidebarArroba: { color: '#aaa', fontSize: 12 },
  sidebarSeguidores: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
  seguidoresBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingVertical: 8, paddingHorizontal: 12, backgroundColor: 'rgb(82, 82, 109)', borderRadius: 8 },
  seguidoresText: { color: 'white', fontSize: 14 },
  sidebarOpciones: { flexDirection: 'column', gap: 10 },
  opcionBtn: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 8, borderRadius: 8 },
  opcionText: { color: 'white', fontSize: 16 },
});
